package me.nomi.urdutyper.app.module
...
import me.nomi.urdutyper.utils.dispatchers.DispatchersProvidersImpl
...
class DataModule {
    ...
    @Provides
    fun provideLogin(firebaseRepository: FirebaseRepositoryImpl): LoginUseCase =
        LoginUseCase(firebaseRepository)

    @Provides
    fun provideLogout(firebaseRepository: FirebaseRepositoryImpl): Logout =
        Logout(firebaseRepository)

    @Provides
    fun provideRegister(firebaseRepository: FirebaseRepositoryImpl): Register =
        Register(firebaseRepository)

    @Provides
    fun provideUserData(firebaseRepository: FirebaseRepositoryImpl): UserData =
